        ...
        item =>
          new Promise(resolve => {
            ...
            img.onerror = () => {
              ...
              pctx.fillStyle = '#c2ff01';
              pctx.font = 'bold 64px Space Grotesk';
              pctx.textAlign = 'center';
              pctx.textBaseline = 'middle';
              pctx.fillText(item.title || 'Tech', cellSize / 2, cellSize / 2);
      ...
      {activeItem && (
        <>
          <div className={`face-title ${isMoving ? 'inactive' : 'active'}`}>
            <h3 className="font-silkscreen text-2xl sm:text-3xl md:text-4xl text-[#c2ff01] font-black drop-shadow-lg tracking-tight">
              {activeItem.title}
            </h3>
            <span className="font-silkscreen text-[10px] text-[#ff4502] font-bold tracking-widest uppercase block mt-1">
              ► ACTIVE TECHNOLOGY
            </span>
          </div>

          <div className={`face-description ${isMoving ? 'inactive' : 'active'}`}>
            <p className="font-space text-xs sm:text-sm text-[#fcfff7] bg-[#0a0a0a]/90 backdrop-blur-md p-3 rounded-xl border border-[#333] shadow-lg leading-relaxed max-w-[200px]">
