...
const DEFAULT_INNER_GRADIENT = 'linear-gradient(145deg, #0a1f05 0%, #002b66 100%)';
...
const ProfileCardComponent = ({
  ...
  behindGlowColor = 'rgba(194, 255, 1, 0.67)',
  behindGlowSize = '45%',
  className = '',
  enableTilt = true,
  ...
  const cardStyle = useMemo(
    () => ({
      ...
      '--behind-glow-color': behindGlowColor ?? 'rgba(194, 255, 1, 0.67)',
